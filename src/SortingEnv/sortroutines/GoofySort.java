...
public class GoofySort extends Sorter {
    ...
    public static void main(String[] args) {
        System.out.println("Array: "+Arrays.toString((new int[]{2,1}))+" GOOFY SORT: "+Arrays.toString(new GoofySort().sort(new int[]{2,1})));
        System.out.println("Array: "+Arrays.toString((new int[]{11,2,13,9,10,8}))+" GOOFY SORT: "+Arrays.toString(new GoofySort().sort(new int[]{11,2,13,9,10,8})));
        System.out.println("Array: "+Arrays.toString((new int[]{11,10,9,8,7,6}))+" GOOFY SORT: "+Arrays.toString(new GoofySort().sort(new int[]{11,10,9,8,7,6})));
